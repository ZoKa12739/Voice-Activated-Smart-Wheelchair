...
#include <Servo.h>  // 引入官方 Servo 库
Servo myServo;      // 创建舵机对象
int angle = 0;      // 用于存储当前角度
...
void setup() {
  ...
  Serial2.begin(38400);  //GPS模块工作波特率为38400
  pinMode(11, OUTPUT);  //左后轮
  pinMode(10, OUTPUT);  //左前轮
  pinMode(9, OUTPUT);   //右后轮
  pinMode(8, OUTPUT);   //右前轮
  ...
  myServo.attach(24);  // 将舵机信号线连接到 24 引脚
  myServo.write(90);    // 初始化舵机至 0°
}
...
// 如果收到串口数据
  ...
  delay(100);  // 适当延时，避免频繁读取


  //你好小爱唤醒语音识别模块
  //语音识别模块Serial3串口14,15：，TX引脚接2560开发14引脚，RX引脚接2560开发15引脚
